...
export const Hero = () => {
  ...
  const handleHireSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post("https://leonstatusprofile.onrender.com/hire/me", formData, {
        headers: {
  ...
  const handleContactSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post("https://leonstatusprofile.onrender.com/messages", formData, {
        headers: {
          "Content-Type": "application/json",
        },
      });
