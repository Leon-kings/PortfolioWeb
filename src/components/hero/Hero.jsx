...
<div className="mb-8 bg-gradient-to-r from-indigo-50 to-purple-50 opacity-200 p-5 rounded-xl border border-indigo-100 relative overflow-hidden">
  ...
  <div className="space-y-3 relative z-10">
    ...
    <Link 
      to={"https://www.google.com/maps/place/Kigali,+Rwanda"} 
    ...
    >
      ...
      <span className="text-gray-700">Kigali, Rwanda</span>
              ...
              {/* Contact Form */}
              <form onSubmit={handleContactSubmit} className="text-black bg-gradient-to-r from-indigo-50 to-purple-50 p-4 rounded-2xl">
                {/* Name Field */}
                <div className="mb-6">
                  <label className="block text-sm font-medium text-gray-700 mb-2 items-center">
                    <svg
