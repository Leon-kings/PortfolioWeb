...
export const Hero = () => {
  ...
  return (
    <section
      className="hero bg-gradient-to-br from-indigo-50 via-purple-50 to-blue-50 py-16 md:py-24"
      id="home"
    >
          ...
          <div className="md:w-1/2 mb-12 md:mb-0">
            <div className="hero-content">
              <div className="hero-text">
                ...
                <div className="typed-text mt-4  text-xl md:text-2xl text-gray-600 mb-6">
              ...
              <div className="mt-25 flex space-x-4">
                <button
            ...
            <div className="p-6">
              ...
              >
                ...
                <div className="mt-8 flex justify-end space-x-3">
                  ...
                  <button
                    type="submit"
                    className="px-6 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg hover:from-indigo-700 hover:to-purple-700 flex items-center transition-all transform hover:-translate-y-0.5 hover:shadow-md"
                  >
                    <svg
        ...
        <>
          <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center bg-black bg-opacity-50 backdrop-blur-sm transition-opacity duration-300">
            ...
            >
              ...
              <div className="sticky top-0 bg-gradient-to-r from-indigo-50 to-purple-50 z-10 p-4 border-b border-gray-200 flex justify-between items-center rounded-t-2xl">
                <h3 className="text-xl font-bold text-gray-900 flex items-center">
                  <svg
              ...
              <div className="p-6">
                {/* Contact Info Card */}
                <div className="mb-8 bg-gradient-to-r from-indigo-50 to-purple-50 p-5 rounded-xl border border-indigo-100 relative overflow-hidden">
                  {/* Decorative elements */}
                  ...
                  <h4 className="text-lg font-medium text-gray-800 mb-3 flex items-center relative z-10">
                    <svg
                  ...
                  <div className="space-y-3 relative z-10">
                    <div className="flex items-center bg-white/70 backdrop-blur-sm p-2 rounded-lg">
                      <svg
                        className="w-5 h-5 text-indigo-600 mr-2"
                        fill="none"
                        stroke="currentColor"
