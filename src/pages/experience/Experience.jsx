...
//               >
//                 <div className={`absolute inset-0 bg-gradient-to-r ${stat.color} rounded-2xl blur-xl opacity-0 group-hover:opacity-20 transition-opacity duration-500`}></div>
//                 <div className="relative bg-white dark:bg-slate-800/90 backdrop-blur-sm rounded-2xl shadow-xl p-6 border border-gray-100 dark:border-slate-700 hover:shadow-2xl transition-all duration-300">
...
//                     className="group relative bg-white dark:bg-slate-800/90 backdrop-blur-sm p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 dark:border-slate-700"
//                   >
//                     {/* Gradient Border on Hover */}
//                     <div className={`absolute inset-0 bg-gradient-to-r ${exp.color} rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 -z-10 blur-sm`}></div>
...
//                     {/* Icon */}
//                     <div className={`absolute -right-4 -top-4 w-16 h-16 bg-gradient-to-r ${exp.color} rounded-2xl shadow-lg flex items-center justify-center text-white transform rotate-6 group-hover:rotate-12 transition-transform duration-500`}>
//                       {exp.icon}
//                     </div>
...
//                   className="group relative"
//                 >
//                   <div className={`absolute inset-0 bg-gradient-to-r ${edu.color} rounded-2xl blur-xl opacity-0 group-hover:opacity-20 transition-opacity duration-500`}></div>
                  
//                   <div className="relative h-full bg-white dark:bg-slate-800/90 backdrop-blur-sm p-6 rounded-2xl shadow-xl border border-gray-100 dark:border-slate-700 hover:shadow-2xl transition-all duration-500">
...
//                 className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-full font-medium shadow-lg hover:shadow-xl transition-all"
//               >
...
//                         className="group relative"
//                       >
//                         <div className="absolute inset-0 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-2xl opacity-0 group-hover:opacity-20 transition-opacity duration-500 blur-xl"></div>
                        
//                         <div className="relative bg-white dark:bg-slate-800/90 backdrop-blur-sm p-6 rounded-2xl shadow-xl border border-gray-100 dark:border-slate-700 hover:shadow-2xl transition-all duration-500">
...
//           {/* Certificates Section - No hover background */}
//           <motion.div
//             initial={{ opacity: 0, y: 30 }}
//             whileInView={{ opacity: 1, y: 0 }}
//             transition={{ duration: 0.6 }}
...
//                         className="relative"
//                       >
//                         <div className="relative bg-white dark:bg-slate-800/90 backdrop-blur-sm p-6 rounded-2xl shadow-xl border border-gray-100 dark:border-slate-700 transition-all duration-500">
//                           <div className="flex items-start justify-between mb-4">
//                             <div className="p-3 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-xl shadow-lg">
//                               <WorkspacePremium className="text-white text-2xl" />
//                             </div>
...
//       {/* Google Drive Certificate Modal */}
//       <Dialog
//         open={modalOpen}
//         onClose={closeModal}
//         maxWidth="lg"
...
//             <WorkspacePremium sx={{ color: '#4f46e5' }} />
...
//           {selectedCertificate && (
//             <iframe
//               src={`${selectedCertificate.url}/preview`}
//               width="100%"
//               height="100%"
