        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="lg:w-1/2">
            <div className="relative group">
              ...
              />
              <div className="absolute -bottom-6 -right-6 bg-gradient-to-r from-indigo-600 to-purple-600 text-white p-6 rounded-lg shadow-lg">
          ...
          <div className="lg:w-1/2">
            <div className="mb-8">
              ...
              <p className="text-gray-600 mb-6">
                ...
                building modern web applications. My expertise spans the entire
                development stack, from crafting beautiful user interfaces to
                designing scalable backend architectures. I specialize in
                JavaScript ecosystems and love solving complex problems with
                  ...
                  <div className="view text-black flex justify-center items-center ">
                    <div className="fixed  z-50">
                      ...
                      <div className="relative group">
                        ...
                        <Link
                          to={'https://drive.google.com/file/d/157XtHzDIztiEqPKuT3QJ8Qtf_ZOjVHiH/view?usp=drive_link'}
                            ...
                            <div className="flex items-start">
                              ...
                              <div>
                                ...
                                <p>
                                  ...
                                  Tailwind CSS documentation for detailed guides
                                  and examples.
                                </p>
                              </div>
                            </div>
